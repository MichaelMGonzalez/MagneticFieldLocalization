public class SerialMsgHeader {
	...
	public static final String[] MSG_KEYS = { "GET_P", "MOVE_BACKWARD_ANALOG", "TURN_RIGHT_ANALOG", "GET_I", "GET_D", "REPORTING_D", "REPORTING_VELOCITY", "REPORTING_BATTERY", "SET_P", "TURN_LEFT_VELOCITY", "REPORTING_STATE", "REPORTING_P", "SET_I", "TURN_LEFT_ANALOG", "TURN_RIGHT_VELOCITY", "GET_VELOCITY", "SET_D", "MOVE_FORWARD_VELOCITY", "STOP", "MOVE_BACKWARD_VELOCITY", "GET_STATE", "MSG_SENT", "GET_BATTERY", "REPORTING_I", "MSG_SIZE", "MOVE_FORWARD_ANALOG" };
	public static final byte[] MSG_VALS = { GET_P, MOVE_BACKWARD_ANALOG, TURN_RIGHT_ANALOG, GET_I, GET_D, REPORTING_D, REPORTING_VELOCITY, REPORTING_BATTERY, SET_P, TURN_LEFT_VELOCITY, REPORTING_STATE, REPORTING_P, SET_I, TURN_LEFT_ANALOG, TURN_RIGHT_VELOCITY, GET_VELOCITY, SET_D, MOVE_FORWARD_VELOCITY, STOP, MOVE_BACKWARD_VELOCITY, GET_STATE, MSG_SENT, GET_BATTERY, REPORTING_I, MSG_SIZE, MOVE_FORWARD_ANALOG };
